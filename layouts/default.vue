<template>
  <main >
      ...
      <template #card >
        ...
        >
          ...
          <p id="app-description" class="mb-2">
            Catepedia is a single-page app
            (SPA) using Vue & Nuxt for searching for cat breeds. It has a search
    ...
    <div class="container mx-auto min-h-screen px-6">
      <header class="py-3 flex justify-center flex-wrap sm:justify-between gap-3">
        <Logo />
        <div class="flex">
          <button
            type="button"
          ...
          <a
            href="https://github.com/Rajesh-Royal/catepedia"
            target="_blank"
            class="p-2 my-2 flex justify-center text-xl outline-none border-2 bg-blue-dark border-blue-dark text-white focus:bg-white focus:text-blue-dark border border-dashed border-white shadow-lg"
  ...
  <footer class="bg-white rounded-lg shadow m-4 dark:bg-gray-800 border border-dashed border-2">
    <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" class="hover:underline">Catepedia™</a>. All Rights Reserved.
    </span>
    <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
        <li>
            <a href="#" class="hover:underline me-4 md:me-6" @click="toggleHelp = !toggleHelp">About</a>
        </li>
        <li>
